...
* Capacitor model for Quantus PEX extracted netlists
.model cmodel C
...
* ---- HVT models (phig shifted by 1xSS for 10x lower Ioff vs RVT) ----
* nmos_hvt: phig=4.27229 (RVT 4.20331 + 68.98mV SS), Ioff ratio = 10.22x
* pmos_hvt: phig=4.88482 (RVT 4.95287 - 68.05mV SS), Ioff ratio = 10.00x
* FreePDK3 HSPICE Models
*
* Copyright (c) 2021, North Carolina State University
* All Rights Reserved.
