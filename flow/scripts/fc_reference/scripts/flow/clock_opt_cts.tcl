...
set set_stage_cmd "set_stage -step cts"
puts "RM-info: Running ${set_stage_cmd}"
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}/set_stage.cts {eval ${set_stage_cmd} -report}
eval ${set_stage_cmd}
...
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}/pre_cts.report_clock_settings {report_clock_settings} ;
redirect -file ${REPORTS_DIR}/${REPORT_PREFIX}/pre_cts.check_clock_tree {check_clock_tree} ;
